...
@Component({
  ...
  template: `
    <!-- Display the thumbs up / down icons with a click event -->
    <svg
    ...
    viewBox="0 0 16 16"
    class="bi bi-hand-thumbs-up vote-icon"
    ...
    <svg
      ...
      height="16"
      fill="currentColor"
      class="bi bi-hand-thumbs-down vote-icon"
